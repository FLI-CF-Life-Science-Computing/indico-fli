...
class ReservationSchema(mm.SQLAlchemyAutoSchema):
    ...
    class Meta:
        model = Reservation
        # TODO addition by SH of service for db reservaltion scheme
        # TODO addition by SH of funding source db reservation schema
        fields = ('id', 'booking_reason', 'service', 'funding', 'booked_for_name', 'room_id', 'is_accepted', 
		'start_dt', 'end_dt',
...
class ReservationDetailsSchema(mm.SQLAlchemyAutoSchema):
    ...
    class Meta:
        model = Reservation
        # TODO addition by SH of funding source to db schema
        # TODO addition by SH of service to db schema
...
class CreateBookingSchema(mm.Schema):
    ...
    # TODO addition by SH of funding source, register as string in db
    ...
    # TODO addition by SH of service register as boolean in db
...
class ReservationLegacyAPISchema(ReservationSchema):
    # XXX: this schema is legacy due to its camelCased keys; do not use it in any new code
    class Meta(ReservationSchema.Meta):
        # TODO addition by SH of funding source
        # TODO addition by SH of service
    ...
    def _rename_keys(self, data, orig, **kwargs):
        ...
        # TODO addition by SH of funding source - not sure if needed
        # TODO addition by SH of service - not sure if needed
